...
#### Template Security Encryption and Decryption 

## About

The goal of tsec is to create a small and portable library for the cipher without heavily focusing on additional programming weight. The library is a small sub library from my personal cipher library. This heavily relies on checksums to conceal values.
