...
The goal of xor is to create a small and portable library for the cipher without heavily focusing on additional programming weight. The library is a small sub library from my personal cipher library.
...
#pragma comment(lib, "xor.lib")

std::string text_string = "world peace";

cipher::xor xrz;

std::string encoded = xrz.encrypt(text_string);
std::cout << "encoded: " << encoded << std::endl;

std::cout << "decoded: " << xrz.decrypt(encoded) << std::endl;
```
